                                ...
                                <form action="#" id="_login_form">
                                    ...
                                    <div class="mt-2 mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" value="<?=$login_token?>" name="remember_login" checked id="remember_login">
                                            <label class="form-check-label" for="remember_login">Remember me</label>
                                        </div>
                                    </div>
                                    <div class="mb-3 mb-0 text-center">
                                        <button class="btn btn-primary text-white rounded k-btn btn-lg col-lg-12 col-12 font-17" id="_login_btn" type="submit"> Log In </button>
                                    </div>
                                    ...
                                    <div class="text-center mb-3">
                                        <button type="button" class="btn-link btn text-primary" id="_forgot_password">Register</button>
                                        <button type="button" class="btn-link btn text-primary" id="_forgot_password">Forgot Password</button>
                                    </div>
                                </form>
                            </div> <!-- end card-body -->
                        </div>
                            ...
                            <div class="modal-dialog modal-md " >
                                <div class="modal-content br-10">
                                    <div class="modal-header ">
                                        <h4 class="modal-title " id="myLargeModalLabel">Recover Account Password</h4>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="check_user_form" class="mt-2">
                                            <div class="row">
                                                <div class="form-floating mb-3 col-lg-12">
                                                    ...
                                                    <label for="question" class="fw-400">Email, Phone number or Username</label>
                                                </div>
                                            </div>
                                            <input type="hidden" name="<?=$csrf_data['name']?>" value="<?=$csrf_data['hash']?>">
                                            <div class="mt-1 pb-2 float-end">
                                                <button id="_forgot_pass_btn" type="submit" class="btn rounded btn-primary c-white">Check User</button>
